...
const INITIAL_DATA: IntakeData = {
  ...
  trainingRestrictions: "", sportSkillOther: "", dietPlan: "", dietPlanOther: "", dietaryRestrictions: "",
};
...
export default function GetStartedPage() {
  ...
  const valid = () => {
    ...
    if (step === 3) return Boolean(data.trainingSplit && data.trainingMethods.length && (!data.sportSkillSports.includes("Other") || data.sportSkillOther.trim()));
